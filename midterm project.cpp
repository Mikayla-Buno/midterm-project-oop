...
void StoreInventory :: addItem() { 
    string choice, id, name, selectedCategory;
	int quantity;
    double price;
    char ans;
    ...
    do{
	        ...
	        if (isdigit(choice[0]) && choice.length() == 1) {
	            ...
	            switch (catChoice) {
	                ...
	                default:
	                    ...
	                    cout << "Category number " << choice << " does not exist!" << endl;
	                    continue;  
	            }
	        }
	        
	        else {
	            if (toLower(choice) == "clothing") {
	                selectedCategory = "Clothing";
	            } 
	            else if (toLower(choice) == "electronics") {
	                selectedCategory = "Electronics";
	            } 
	            else if (toLower(choice) == "entertainment") {
	                selectedCategory = "Entertainment";
	            } 
	            else {
	                cout << "Invalid Category!\n";
    	...
    	items.push_back(new DisplayInventory(id, name, quantity, price, selectedCategory));
